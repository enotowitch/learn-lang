...
export default function Answer() {
	...
	let { words, setWords, answerStatus, answer, setAnswer, lastCorrectAnswer, setLastCorrectAnswer, langFrom, langTo, random, setRandom, listNum, setListNum } = useContext(Context)
